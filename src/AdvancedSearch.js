...
import './AdvancedSearch.css'; // Make sure this CSS file is included
    ...
    return (
        <div className="advanced-search-container">
            ...
            <div className="advanced-search-form">
                ...
                <input type="date" placeholder="Date Added" onChange={e => onSearchChange('addedDate', e.target.value)} />
                <input type="text" placeholder="Postcode Area" onChange={e => onSearchChange('postcodeArea', e.target.value)} />
